<!-- Placeholder just in case, but I'll write full HTML as per Pelanggan -->
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
                                href="{{ route('admin.dashboard') }}">Pages</a>
                        </li>
                        <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
                        ...
                        <div class="card-header pb-0">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex gx-2">
                                    <form action="{{ route('admin.articles.like', $article->slug) }}" method="POST"
                                        class="me-2">
                                        @csrf
                                        <button type="submit"
                                    ...
                                    <form action="{{ route('admin.articles.bookmark', $article->slug) }}" method="POST">
                                        @csrf
                                        <button type="submit"
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- Comment Form -->
                            <form action="{{ route('admin.articles.comments.store', $article->slug) }}" method="POST"
                                class="mb-4">
                                @csrf
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <form action="{{ route('admin.comments.destroy', $comment->id) }}" method="POST"
                                                ...
                                                <button type="button" class="btn btn-link btn-sm text-danger p-0"
                                                    onclick="showDeleteModal(this.closest('form'), 'Komentar ini akan dihapus permanen!')">Delete</button>
                                            </form>
                                        </div>

                                        <!-- Reply Form -->
                                        <div id="reply-form-{{ $comment->id }}" class="mt-2 d-none">
                                            <form action="{{ route('admin.articles.comments.store', $article->slug) }}"
                                                method="POST">
                                                @csrf
