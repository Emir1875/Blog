                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-3">
                            <form role="form" method="POST"
                                action="{{ route('staff.articles.update', $article->slug) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            @if($article->image)
                                                <div class="mb-2">
                                                    <img src="{{ asset('storage/' . $article->image) }}"
                                                        class="img-fluid border-radius-lg" alt="Article Image">
                                                </div>
                                            @endif
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <small class="text-muted">Ubah status artikel sesuai kebutuhan</small>
                                        </div>
                                        <div class="text-center">
                                            <button type="submit" class="btn bg-gradient-primary w-100 my-4 mb-2">Update
                                                Article</button>
                                        </div>
                                    </div>
                                </div>
