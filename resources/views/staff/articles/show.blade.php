                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
                                href="{{ route('staff.dashboard') }}">Pages</a>
                        </li>
                        <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
                                href="{{ route('staff.articles.manage') }}">Articles</a>
                        </li>
                        ...
                        <div class="card-header pb-0">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex gx-2">
                                    <form action="{{ route('staff.articles.like', $article->slug) }}" method="POST"
                                        class="me-2">
                                        @csrf
                                        <button type="submit"
                                    ...
                                    <form action="{{ route('staff.articles.bookmark', $article->slug) }}" method="POST">
                                        @csrf
                                        <button type="submit"
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- Comment Form -->
                            <form action="{{ route('staff.articles.comments.store', $article->slug) }}" method="POST"
                                class="mb-4">
                                @csrf
                                ...
                                <div class="d-flex mb-4">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div id="reply-form-{{ $comment->id }}" class="mt-2 d-none">
                                            <form action="{{ route('staff.articles.comments.store', $article->slug) }}"
                                                method="POST">
                                                @csrf
